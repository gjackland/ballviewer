...
/**
 * Represents a ball for 2d or 3d drawing.
 * <p>
 * Ball does NOT extend Particle and has none of its functionality. It is
 * specified by a position (Vector3), a diameter and a colour.
 */
public class Ball extends SystemObject implements Positionable
{
	...
	public Ball( final Vector3 posin, final double d, final Color col )
	{
		this.pos = posin;
		this.diameter = d;
		this.colour = col;
	...
	public void setDiameterOffset( final double offset )
	{
	...
	public Object copy()
	{
		return new Ball( ( Vector3 )this.pos.clone(), this.diameter, this.colour );
	}
