...
public class AnalysisMenu extends JMenu
{
	...
	private class AnalyserMenu extends JMenu implements ActionListener
	{
		...
		private final AnalysisManager	analysisManager;	// The manager
															// responsible for
															// managing analysis
															// operations
		private final Analyser			analyser;			// The analyser that
															// this class
															// represents the
															// menu for
		...
		AnalyserMenu( final JFrame owner, final AnalysisManager analysisManager, final Analyser analyser )
		{
			super();
	...
	private final JFrame			owner;												// The
																						// frame
																						// that
																						// this
																						// menu
																						...
																						// displayed
																						// in
	private final AnalysisManager	analysisManager;									// The
																						// analysis
																						// manager

	private final JMenu				mAnalysisBalls	= new JMenu( "Ball Analysers" );
	// Group all the ball analysers together as only one can be selected at a
	// time
	private ButtonGroup				bgBallAnalysers;

	public AnalysisMenu( final JFrame owner, final AnalysisManager analysisManager )
	{
		super( "Analysis" );
		this.owner = owner;
		this.analysisManager = analysisManager;
