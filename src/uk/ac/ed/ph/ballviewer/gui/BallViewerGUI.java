 ...
 */
public class BallViewerGUI extends JFrame implements
ActionListener, ItemListener, TextListener, MouseListener, MouseMotionListener, MouseWheelListener,
AttributeAttachListener, TimelineListener, NewExperimentListener
{
	private class ControlPanel extends JPanel implements ActionListener, ChangeListener, ItemListener
	{
		...
		ControlPanel(
			final BallViewerGUI			ballViewer,
...
//			}
	...
	private final			JSlider							sTimeline;												// Timeline slider
...
//	}
	...
	void setCameraPosition(Vector3 camPos) {	// these are extremely messy, but do make sense
