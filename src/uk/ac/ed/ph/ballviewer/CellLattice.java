...
/**
 * References Objects in a 3d arrangement to allow neighbours to be found
 * quickly. Contains a 3d array of ObjectLists, corresponding to a specifed 3d
 * range (cuboid) which is divided into equal cells of a specified size.
 */
...
class CellLatticePeriodic extends CellLatticeCore
{
	 ...
	 * increased to
	 */
	public CellLatticePeriodic( final SystemCell supercell, final double cs )
	{
		super( supercell, cs );
...
class LatticeCoor
{
	...
	public LatticeCoor( int ix, int iy, int iz )
	{
		x = ix;
		y = iy;
		z = iz;
