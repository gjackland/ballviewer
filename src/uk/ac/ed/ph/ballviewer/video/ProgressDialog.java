...
public class ProgressDialog extends JMDialog
{
	...
	public ProgressDialog( final Frame frame, final String strTitle, final int nMin, final int nMax, final ActionListener listener )
	{
	...
	public ProgressDialog( final Frame frame, final String strTitle, final String strMessage, final Component component, final ActionListener listener )
	{
		super( frame, strTitle, false );
	...
	public void setCurPos( int nPos )
	{
		...
		{
			labelProgress.setText( JMFI18N.getResource( "jmstudio.saveprogress.saved" ) + " " + nPos + " " + JMFI18N.getResource( "jmstudio.saveprogress.seconds" ) + "..." );
		}
	}
