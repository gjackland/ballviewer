...
public final class EventDispatcher
{
	...
	private final Hashtable< Class< ? extends BallViewerEvent< ? > >, ArrayList >	listenersMap	= new Hashtable< Class< ? extends BallViewerEvent< ? > >, ArrayList >( 10 );

	// Add a listener to an event class
	public < T > void listen( final Class< ? extends BallViewerEvent< T > > eventClass, final T listener )
	{
	...
	public < T > void notify( final BallViewerEvent< T > event )
	{
	...
	private < T > ArrayList< T > getListenersOf( Class< ? extends BallViewerEvent< T > > eventClass )
	{
		@SuppressWarnings( "unchecked" )
