...
{
	private final Hashtable< Class< ? >, Class< ? extends ReflectionType > >		editorRegistry
		= new Hashtable< Class< ? >, Class< ? extends ReflectionType > >();
		
		
	public ReflectionType
	findEditor( final Class< ? > targetType )
	{
	...
	registerEditor(
		...
		final Class< ? extends ReflectionType > editorClass
	)
	{
