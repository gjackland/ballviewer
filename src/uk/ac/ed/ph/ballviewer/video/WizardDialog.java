											 ...
											 */
{
	...
	public WizardDialog( final Frame frameOwner, final String strTitle, final boolean boolModal, final String strImage, final JPanel arrPages[] )
	{
	...
	public void setPages( final JPanel arrPages[] )
	{
		int i;
		int nCount;
	...
	private void setPage( final JPanel panelPage )
	{
		if( panelPage == null )
			return;
	...
	protected boolean onPageDone( final JPanel panelPage )
	{
		return( true );
	}
	...
	protected JPanel getFirstPage()
	{
		...
		{
			panelPage = vectorPages.firstElement();
		}
		return( panelPage );
	}
	...
	protected boolean isFirstPage( final JPanel panelPage )
	{
		boolean boolResult;
	...
	protected boolean isLastPage( final JPanel panelPage )
	{
		boolean boolResult;
