...
public class AttributeAttachEvent implements BallViewerEvent< AttributeAttachListener >
{
	 ...
	 * 
	 * @param attached
	 *            true if the attribute was attached, false if detached
	 * @param output
	 *            The analyser output that the attribute was attached to
	 * @param attribute
	 *            The attribute that was attached
	 */
	public AttributeAttachEvent( final boolean attached, final AnalyserOutput output, final SysObjAttribute attribute )
	{
	...
	@Override
	public void notify( final AttributeAttachListener listener )
	{
		if( attached )
		{
