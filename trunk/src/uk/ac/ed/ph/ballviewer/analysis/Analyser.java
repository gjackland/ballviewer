...
public abstract class Analyser< T extends Options > implements Optionable< T >
{
	...
	@Override
	public void setOptions( final T newOptions )
	{
	...
	/**
	 * This should be used by implementing classes to initialise the analyser
	 * and make calls to
	 * AnalysisManager.attach(BallAnalyser|GraphAnalyser|DrawAnalyser) as
	 * appropriate to make sure they recieve the correct update calls etc.
	 * 
	 */
	public abstract void initialise( final AnalysisManager manager );
}
